...
function imageChangeWindowResize() {
	...
	if (window.innerWidth < 900 && window.innerWidth > 300) {
		...
		document.getElementById('softwareDevelopmenti').src = 'img/BannerExpertise.webp';
		document.getElementById('abouti').src = 'img/BannerRate.webp';
		document.getElementById('contacti').src = 'img/BannerFree.webp';
		document.getElementById('ratesi').src = 'img/BannerRate.webp';
		...
		document.getElementById('contacti').style.display = 'none';
		document.getElementById('ratesi').style.display = 'none';
		document.getElementById('softwareDevelopmenti').src = 'img/AQC Square Ad 04.webp';
		document.getElementById('abouti').src = 'img/AQC Square Ad 01.webp';
		document.getElementById('contacti').src = 'img/AQC Square Ad 05.webp';
		document.getElementById('ratesi').src = 'img/BannerRate.webp';
		document.getElementById('softwareDevelopmenti').style.display = 'inline-flex';
		document.getElementById('abouti').style.display = 'inline-flex';
		document.getElementById('contacti').style.display = 'inline-flex';
		...
		document.getElementById('abouti').src = 'img/AQC Square Ad 01.webp';
		document.getElementById('contacti').src = 'img/AQC Square Ad 05.webp';
		document.getElementById('ratesi').src = 'img/AQC Square Ad 05.webp';
		document.getElementById('softwareDevelopmenti').style.display = 'inline-flex';
		document.getElementById('abouti').style.display = 'inline-flex';
		document.getElementById('contacti').style.display = 'inline-flex';
		document.getElementById('ratesi').style.display = 'inline-flex';
